...
- Lab 7.1/7.2: The compile times can be upwards of 20 minutes based on your computer (may be less as Fall 2023 will have new software and hardware). This lab is the first "design" lab and, admittedly, is the most time-consuming one (apart from Lab 2.1), according to Professor Cheng. There is also quite a lot of staring at waveforms in order to ensure AXI handshaking works properly. 
